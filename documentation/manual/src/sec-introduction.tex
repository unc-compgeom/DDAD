...
3 to show how to leverage existing DDAD types to implement a simple
2-dimensional algorithm. The inner workings of these types are revealed in
section 4. We conclude by studying incremental Delaunay triangulation to show
