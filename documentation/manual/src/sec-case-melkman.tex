...
The code listed below shows the Melkman function which is our C++ implementation
of Melkman's algorithm. The function takes as input a Polyline\_2r and an
IGeometryObserver, and produces as output a Polygon\_2r object. All branching
tests make use of the RIsLeftOrInsidePQ predicate, which encapsulates the logic
described in the previous section. We will describe each of these in the
