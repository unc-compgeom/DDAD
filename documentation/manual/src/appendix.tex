...
can serve as background for some of the concepts found in the main paper.
...
\href{https://github.com/unc-compgeom/DDAD/issues/8}{this} issue for plans to
allow for multiple-object selection.
...
so on. Most of this functionality is not yet implemented, see
...
\lstinputlisting[caption=Example Select Method,
