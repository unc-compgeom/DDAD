...
implementation or the high level algorithm description. Oftentimes, these will
overlap, but there may be times where visualizing implementation details
clutters the presentation of the high level algorithm.
