...
The DDAD workbench extends Millman's DDAD library to make it easier for
implementers and presenters to visualize degree-driven geometric
algorithms. Momentarily, we explain the desiderata of the DDAD workbench in
terms of the taxonomy defined in section~\ref{sec:taxonomy}. First, we explain
what degree-driven algorithm design is by examining the nature of geometric
